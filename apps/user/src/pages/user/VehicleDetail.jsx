    ...
    if (!vehicle) {
        return (
            <div style={{ paddingTop: '120px', textAlign: 'center', height: '100vh', background: 'var(--bg-primary)' }}>
                ...
                <button className="btn btn-primary" onClick={() => navigate('/vehicles')} style={{ marginTop: '20px' }}>Back to Fleet</button>
            </div>
        );
    }
            ...
            <div style={{ position: 'relative', height: '65vh', minHeight: '500px', display: 'flex', alignItems: 'flex-end', paddingBottom: '60px' }}>
                ...
                <div className="container" style={{ position: 'relative', zIndex: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', width: '100%', flexWrap: 'wrap', gap: '20px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px', background: 'rgba(15, 15, 15, 0.6)', backdropFilter: 'blur(10px)', padding: '12px 20px', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.05)' }}>
                         ...
                         <div>
                            <div style={{ fontSize: '0.625rem', color: '#888', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '4px', fontWeight: '600' }}>Base Camp Weather</div>
                            <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px' }}>
                                <span style={{ fontSize: '1.25rem', fontWeight: '700', lineHeight: 1 }}>-4°C</span>
                                <span style={{ fontSize: '0.75rem', color: '#888' }}>/ Clear Sky</span>
                            </div>
                         </div>
                    </div>
                </div>
            ...
            <div className="container" style={{ marginTop: '40px' }}>
                <div style={{ display: 'flex', gap: '40px', flexWrap: 'wrap' }}>
                    ...
                    <div style={{ flex: '1 1 60%', minWidth: '300px' }}>
                        ...
                        {/* QUICK SPECS ROW */}
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: '20px', background: '#161616', padding: '30px', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.02)', marginBottom: '40px' }}>
                            <div>
                                <div style={{ fontSize: '0.625rem', color: '#888', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '8px', fontWeight: '600' }}>Engine</div>
                                <div style={{ fontSize: '1.125rem', fontWeight: '600' }}>{vehicle.engine}</div>
                            </div>
                            <div>
                                <div style={{ fontSize: '0.625rem', color: '#888', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '8px', fontWeight: '600' }}>Torque</div>
                                <div style={{ fontSize: '1.125rem', fontWeight: '600' }}>{vehicle.torque}</div>
                            </div>
                            <div>
                                <div style={{ fontSize: '0.625rem', color: '#888', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '8px', fontWeight: '600' }}>Drive</div>
                                <div style={{ fontSize: '1.125rem', fontWeight: '600' }}>{vehicle.drive}</div>
                            </div>
                            <div>
                                <div style={{ fontSize: '0.625rem', color: '#888', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '8px', fontWeight: '600' }}>Capacity</div>
                                <div style={{ fontSize: '1.125rem', fontWeight: '600' }}>{vehicle.capacity}</div>
                            </div>
                        </div>

                        {/* CAPABILITIES */}
                        <h3 style={{ fontSize: '1.25rem', fontWeight: '700', marginBottom: '20px' }}>Expedition Capabilities</h3>
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', marginBottom: '40px' }}>
                            {vehicle.capabilities.map((cap, i) => {
                                const IconComp = icons[cap.icon] || Settings;
                                return (
                                <div key={i} style={{ background: '#161616', padding: '24px', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.02)', display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                                    <div style={{ background: 'rgba(255,255,255,0.05)', width: '36px', height: '36px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                                        <IconComp size={16} color="var(--accent)" />
                                    </div>
                                    <div>
                                        <div style={{ fontWeight: '600', marginBottom: '8px', fontSize: '0.9375rem' }}>{cap.title}</div>
                                        <p style={{ fontSize: '0.8125rem', color: '#888', lineHeight: 1.6, margin: 0 }}>{cap.desc}</p>
                                    </div>
                                </div>
                            )})}
                        </div>
                        ...
                        <h3 style={{ fontSize: '1.25rem', fontWeight: '700', marginBottom: '20px' }}>Altitude Tolerance</h3>
                        <div style={{ background: '#161616', padding: '40px 30px', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.02)', marginBottom: '40px', position: 'relative' }}>
                            <div style={{ display: 'flex', alignItems: 'flex-end', gap: '4px', height: '120px', marginBottom: '16px', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                                ...
                                <div style={{ flex: 1, height: '100%', background: '#b3d4ff', borderTopLeftRadius: '4px', borderTopRightRadius: '4px', position: 'relative' }}>
                                    <div style={{ position: 'absolute', top: '-36px', left: '50%', transform: 'translateX(-50%)', background: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(5px)', padding: '4px 12px', borderRadius: '20px', fontSize: '0.625rem', whiteSpace: 'nowrap', border: '1px solid rgba(255,255,255,0.1)' }}>Target: {vehicle.altitude?.target || '5,416m'}</div>
                                </div>
                            </div>
                            <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.625rem', color: '#666', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                        ...
                        {/* TECHNICAL SPECS */}
                        <h3 style={{ fontSize: '1.25rem', fontWeight: '700', marginBottom: '20px' }}>Technical Specifications</h3>
                        <div style={{ background: '#161616', padding: '30px', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.02)' }}>
                            {vehicle.technicalSpecs.map((spec, i) => (
                                <div key={i} style={{ display: 'flex', borderBottom: i !== vehicle.technicalSpecs.length - 1 ? '1px solid rgba(255,255,255,0.05)' : 'none', padding: '16px 0', alignItems: 'center' }}>
                                    <div style={{ width: '250px', fontSize: '0.8125rem', color: '#888' }}>{spec.label}</div>
                    ...
                    <div style={{ flex: '1 1 35%', minWidth: '320px' }}>
                        <div style={{ position: 'sticky', top: '100px', background: '#1c1c1c', padding: '40px', borderRadius: '32px', border: '1px solid rgba(255,255,255,0.05)', boxShadow: '0 20px 40px rgba(0,0,0,0.5)' }}>
                            <div style={{ fontSize: '0.625rem', color: '#888', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '8px', fontWeight: '600' }}>Starting From</div>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '32px' }}>
                                <div>
                                    <span style={{ fontSize: '3.5rem', fontWeight: '800', color: 'var(--accent)', lineHeight: 1 }}>${finalPrice}</span>
                                    <span style={{ fontSize: '1rem', color: '#888' }}>/day</span>
                                </div>
                            ...
                            {/* TABS */}
                            <div style={{ display: 'flex', background: 'rgba(255,255,255,0.03)', borderRadius: '16px', padding: '4px', marginBottom: '32px' }}>
                                <button 
                            ...
                            <div style={{ marginBottom: '40px' }}>
                                <div style={{ fontSize: '0.8125rem', fontWeight: '600', marginBottom: '16px', color: '#fff' }}>Adventure Add-ons</div>
                            ...
                            <div style={{ textAlign: 'center', marginTop: '20px', fontSize: '0.625rem', color: '#666', textTransform: 'uppercase', letterSpacing: '1px' }}>
