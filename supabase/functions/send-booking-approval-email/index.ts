...
function buildEmail({ booking, user, vehicle }: Required<RequestPayload>) {
  ...
  return {
    subject: `Your booking is confirmed: ${vehicle.name}`,
    html: `
      <div style="font-family: Arial, sans-serif; color: #1f2937; line-height: 1.5;">
        <h2 style="color: #111827;">Your booking is confirmed</h2>
        <p>Hello ${userName},</p>
        <p>Your vehicle booking has been approved. Your reservation is now confirmed.</p>
        ...
        <p style="margin-top: 18px;">Thank you for booking with BHATBHATIFY.</p>
      </div>
    `,
    text: [
      `Hello ${user.name},`,
      '',
      'Your vehicle booking has been approved. Your reservation is now confirmed.',
      ...
      '',
      'Thank you for booking with BHATBHATIFY.',
    ].join('\n'),
  }
}
